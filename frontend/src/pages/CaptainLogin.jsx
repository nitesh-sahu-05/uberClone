...
const CaptainLogin = () => {
  ...
  return (
      ...
      <div>
        <Link to="/login" className="bg-[#f5f502] flex items-center justify-center font-bold text-xl text-black mt-5 w-full py-4 px-4 rounded hover:bg-gray-500 cursor-pointer">
          Sign in as User
        </Link>
      </div>
    </div>
